...
{% hint style="info" %}
**For more information** on how to get started and register your application with our Marketplace, please see our [welcome guide](https://dev.marketplace.reapit.cloud/developer/welcome).
{% endhint %}

...
8. Add a form to the table slide down component that updates the property address fields. On submit, the form should update the API and the table should refresh with the updated property info. There is an example form in the CRA template, you are free to add any third party form library you like. TIP: take time to read about [etags and the if-match header here.](https://foundations-documentation.reapit.cloud/api/api-documentation#optimistic-concurrency)<br>
